...
enum MessageType : int {
  ...
  MessageType_PinMatrixAck PROTOBUF_DEPRECATED = 19,
  ...
  MessageType_FirmwareErase PROTOBUF_DEPRECATED = 6,
  MessageType_FirmwareUpload PROTOBUF_DEPRECATED = 7,
  MessageType_FirmwareRequest PROTOBUF_DEPRECATED = 8,
  MessageType_FirmwareErase_ex PROTOBUF_DEPRECATED = 16,
  MessageType_SelfTest PROTOBUF_DEPRECATED = 32,
  MessageType_Reboot = 30000,
  MessageType_FirmwareUpdate = 30001,
  ...
  MessageType_FsStat = 30100,
  MessageType_FsInfo = 30101,
  MessageType_FsRemove = 30102,
  MessageType_FsFile = 30103,
  MessageType_FsFileRead = 30104,
  MessageType_FsFileWrite = 30105,
  MessageType_FsChunk = 30106,
  MessageType_FsRead = 30107,
  MessageType_FsWrite = 30108,
  MessageType_FsMkdir = 30109,
  MessageType_FsFsStat = 30110,
  MessageType_FsFsInfo = 30111,
  MessageType_FsChecksums = 30112,
  ...
  MessageType_EthereumStoreDefinition = 471,
  ...
  MessageType_TonSignTx = 11908,
  MessageType_TonSignedTx = 11909,
  ...
  MessageType_NftUpload = 10018,
  MessageType_NftRequest = 10019,
  MessageType_NftAck = 10021,
  MessageType_ListResDir = 10023,
  MessageType_FileInfoList = 10024,
  MessageType_SEInitialize = 10025,
  MessageType_SEInitializeDone = 10026,
  MessageType_SEBackToRomBoot = 10027,
  MessageType_SEWipeUserStorage = 10028
};
bool MessageType_IsValid(int value);
constexpr MessageType MessageType_MIN = MessageType_Initialize;
constexpr MessageType MessageType_MAX = MessageType_FsChecksums;
