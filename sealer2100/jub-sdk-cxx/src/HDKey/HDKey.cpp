...
JUB_RV hdnode_pub_ckd(std::string xpub, std::string path, std::string curve, JUB_UINT32 xpubPrefix ,JUB_UINT32 xprvPrefix,HDNode_HPY* node, JUB_UINT32* parentFingerprint) {
    HDNode_HPY hdkey;
...
JUB_RV hdnode_priv_ckd(std::string xprv, std::string path, std::string curve, JUB_UINT32 xpubPrefix ,JUB_UINT32 xprvPrefix,HDNode_HPY* node, JUB_UINT32* parentFingerprint) {
    HDNode_HPY hdkey;
