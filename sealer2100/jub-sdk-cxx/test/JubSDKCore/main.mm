...
void main_test() {
    ...
    while (true) {
        ...
        NSLog(@"|   2. device_fgpt_test.                  |\n");
        NSLog(@"|                                         |\n");
        NSLog(@"|  31.   BTC_test.                        |\n");
        NSLog(@"|  32.   BTC_segwit(p2sh_p2wpkh)_test.    |\n");
        NSLog(@"|  33.   BTC_mutilsign_test.              |\n");
        NSLog(@"|  34.   BTC_segwit(p2wpkh)_test.         |\n");
        NSLog(@"|  35.   BTC_segwit(p2wpkh)_test(testnet).|\n");
        NSLog(@"|                                         |\n");
...
//                BTC_test(deviceID, "json/testBTC45_1.json", NS_COINBTC);
                ...
                break;
            case 34:
                BTC_test(deviceID, "json/testBTC84.json", NS_COINBTC);
                break;
            case 35:
                BTC_test(deviceID, "json/testBTCTN84.json", NS_COINBTC);
                break;
            case 145:
...
//                ETH_test(deviceID, "json/testETH_newToken.json");
            ...
            case 64:
                ...
                break;
            case 65:
                ETH_test(deviceID, "json/testETH_Uniswap.json");
                break;
            case 461:
                FIL_test(deviceID, "json/testFIL.json");
                break;
            case 171:
...
//                EOS_test(deviceID, "json/testEOS_mix.json");
                break;
            case 195:
                TRX_test(deviceID, "json/testTRX.json");
                break;
            case 501:
                SOL_test(deviceID, "json/testSOL.json");
                break;
#endif // #if USE_DEVICE
#if TREZOR_CRYPTO
            case 91:
