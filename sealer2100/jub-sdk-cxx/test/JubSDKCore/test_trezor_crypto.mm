...
void address_code_test() {
    ...
    if (0 >= hyp_base58_decode_check(address.c_str(), HasherType::HASHER_SHA2D, (uint8_t*)str, strsize)) {
//    if (0 >= hyp_base58_encode_check(data, datalen, HasherType::HASHER_SHA2D, str, strsize)) {
