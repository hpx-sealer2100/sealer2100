...
* **[`core/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/core/CHANGELOG.md)** for HyperMate T firmware
* **[`core/embed/boardloader/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/core/embed/boardloader/CHANGELOG.md)** for HyperMate T boardloader
* **[`core/embed/bootloader/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/core/embed/bootloader/CHANGELOG.md)** for HyperMate T bootloader
* **[`core/embed/bootloader_ci/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/core/embed/bootloader_ci/CHANGELOG.md)** for HyperMate T CI bootloader
* **[`legacy/firmware/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/legacy/firmware/CHANGELOG.md)** for HyperMate 1 firmware
* **[`legacy/bootloader/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/legacy/bootloader/CHANGELOG.md)** for HyperMate 1 bootloader
* **[`legacy/intermediate_fw/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/legacy/intermediate_fw/CHANGELOG.md)** for HyperMate 1 intermediate firmware
* **[`python/CHANGELOG.md`](https://github.com/ziancube/hypermate-touch-firmware/blob/master/python/CHANGELOG.md)** for Python client library
...
As an example, an entry describing bug fix for issue 1234 in HyperMate T firmware
