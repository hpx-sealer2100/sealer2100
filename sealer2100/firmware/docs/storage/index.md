...
The `storage` folder contains the implementation of HyperMate's internal storage, which is common for both Legacy (HyperMate One) and Core (HyperMate T). This README also contains a detailed description of the cryptographic design.
