# Use of SLIP-39 in HyperMate-core
...
This does not quite match HyperMate's use of the "passphrase protection" feature, namely
...
## Seed handling in HyperMate

HyperMate stores a _mnemonic secret_ in a storage field `_MNEMONIC_SECRET`. This is the
...
Only the functions denoted in **bold** are implemented in HyperMate-core. Recovery shares
