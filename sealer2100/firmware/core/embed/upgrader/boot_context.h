...
typedef enum {
  UPGRADER_OP_STATE_NONE,
  UPGRADER_OP_STATE_BOOT_INSTALL,
  UPGRADER_OP_STATE_BOOT_INSTALLING,
  UPGRADER_OP_STATE_BOOT_INSTALL_DONE,
  UPGRADER_OP_STATE_FIRMWARE_INSTALL,
  UPGRADER_OP_STATE_FIRMWARE_INSTALLING,
  UPGRADER_OP_STATE_FIRMWARE_INSTALL_DONE,
  UPGRADER_OP_STATE_SE_INSTALL,
  UPGRADER_OP_STATE_SE_INSTALLING,
  UPGRADER_OP_STATE_SE_INSTALL_DONE,
  UPGRADER_OP_STATE_INSTALL_FAILED,
  UPGRADER_OP_STATE_DONE,
} upgrader_op_state_t;

typedef struct {
  upgrader_op_state_t state;
  const char* path;
