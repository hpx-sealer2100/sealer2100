...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "secure_heap.h"   /*Header for the dynamic memory function*/
    #define LV_MEM_CUSTOM_ALLOC   pvPortMalloc
    #define LV_MEM_CUSTOM_FREE    vPortFree
    #define LV_MEM_CUSTOM_REALLOC pvPortReMalloc
#endif     /*LV_MEM_CUSTOM*/
 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE 11
...
#define LV_FONT_CUSTOM_DECLARE \
    LV_FONT_DECLARE(lv_font_ping_fang_medium_20) \
    LV_FONT_DECLARE(lv_font_ping_fang_medium_32) \
    LV_FONT_DECLARE(lv_font_ping_fang_medium_44) \
    LV_FONT_DECLARE(lv_font_ping_fang_regular_20) \
    LV_FONT_DECLARE(lv_font_ping_fang_regular_24) \
    LV_FONT_DECLARE(lv_font_mono_reg_28) \
    LV_FONT_DECLARE(lv_font_status_bar)

/*Always set a default font*/
#define LV_FONT_DEFAULT &lv_font_ping_fang_regular_24
