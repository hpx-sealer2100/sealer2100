...
#define USE_EXTERN_FLASH 1
  ...
  #define FLASH_SECTOR_COUNT           (16 + 128)
...
#if USE_EXTERN_FLASH
  #define FLASH_SECTOR_STORAGE_1 (16 + 126)
  #define FLASH_SECTOR_STORAGE_2 (16 + 127)
#else
...
#define FLASH_SECTOR_BOOTLOADER_END   2
...
#define FLASH_SECTOR_FIRMWARE_EXTRA_END   63

#define BOOTLOADER_SECTORS_COUNT          (3)
#define STORAGE_SECTORS_COUNT             (2)
#define FIRMWARE_SECTORS_COUNT            (12 + 48)
...
#define FLASH_STATUS_ALL_FLAGS                                                                               \
    (FLASH_SR_RDERR | FLASH_SR_PGSERR | FLASH_SR_PGPERR | FLASH_SR_PGAERR | FLASH_SR_WRPERR | FLASH_SR_SOP | \
     FLASH_SR_EOP)
...
secbool flash_write_bytes(uint8_t sector, uint32_t offset, uint8_t* data, uint32_t len);
...
#define FLASH_OTP_IRIS_PRE_SHARED_KEY 10
