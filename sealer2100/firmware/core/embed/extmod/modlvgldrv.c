...
static mp_obj_t mp_disp_drv_framebuffer(mp_obj_t n_obj) {
  ...
  static uint8_t* lvgl_buf_base = (void *)SDRAM_LVGL_ADDRESS;
...
static void mp_register_fs(mp_obj_t obj) {
...
STATIC const mp_rom_map_elem_t lvgl_drv_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_register_fs), MP_ROM_PTR(&PTR_OBJ(mp_register_fs))},
