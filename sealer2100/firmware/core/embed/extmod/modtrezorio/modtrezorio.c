...
/// CAMERA: int # interface id of camera scaning

/// CAMERA_STATE: int # interface id for camera capturing state

/// IRIS: int # interface id for iris

STATIC const mp_rom_map_elem_t mp_module_trezorio_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_trezorio)},

#if defined TREZOR_MODEL_T
    {MP_ROM_QSTR(MP_QSTR_fs), MP_ROM_PTR(&mod_trezorio_fs_module)},
    {MP_ROM_QSTR(MP_QSTR_SBU), MP_ROM_PTR(&mod_trezorio_SBU_type)},

    {MP_ROM_QSTR(MP_QSTR_IRIS), MP_ROM_INT(IRIS_IFACE)},
    {MP_ROM_QSTR(MP_QSTR_CAMERA_STATE), MP_ROM_INT(CAMERA_STATE_IFACE)},
    {MP_ROM_QSTR(MP_QSTR_CAMERA), MP_ROM_INT(CAMERA_IFACE)},
    ...
    {MP_ROM_QSTR(MP_QSTR_BUTTON_POWER), MP_ROM_INT(BTN_POWER)},
    ...
    {MP_ROM_QSTR(MP_QSTR_Iris), MP_ROM_PTR(&mod_trezorio_Iris_type)},
