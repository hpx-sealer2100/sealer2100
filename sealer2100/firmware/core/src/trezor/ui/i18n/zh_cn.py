...
class Text:
    ...
    delete_nft_desc = "确定要删除当前 NFT 吗？\n\n删除 NFT 操作仅从设备中移除 NFT，NFT 并不会从区块链中删除。\n\n您可以随时重新添加 NFT。"
    enable_pin="启用 PIN 码"
    ...
    iris_desc="虹膜验证是一种基于您独特虹膜特征的生物识别技术，提供最高级别的安全保障，确保只有您能访问您的钱包。"
    ...
    approve_confirm_desc = "授权后，您将允许该 dApp 转账当前代币资产或为您自动执行交易。"
    approve_to = "授权给"
    allowance = "授权额度"
    contract = "代币合约"
    unlimited = "无限量"
...
class Subtitle:
    ...
    qr_connect_wallet_desc_metamask = "打开 MetaMask 钱包扫描下方二维码，支持Ethereum 和 EVM 网络。"
    qr_connect_wallet_desc_hpx = "打开 HPX 钱包扫描下方二维码，支持Bitcoin、Solana、Tron、Ethereum以及EVM网络。"
