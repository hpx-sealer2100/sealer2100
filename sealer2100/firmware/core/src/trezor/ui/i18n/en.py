...
class Title:
    ...
    eip712_sign_message = "Sign {} message"
    ...
    power_off = "Are you sure you want to power off?"
...
class Subtitle:
    ...
    qr_connect_wallet_desc_metamask = "Open the MetaMask wallet and scan the QR code below. Supports Ethereum and EVM networks."
    qr_connect_wallet_desc_hpx = "Open the HPX wallet and scan the QR code below. Supports Bitcoin, Solana, Tron, Ethereum, and EVM networks."
...
class Text:
    ...
    delete_nft_desc = "Are you sure you want to delete the current NFT?\n\n Delete NFT operation only remove the NFT from the device, NFT is not deleted from the blockchain. \n\nYou can add the NFT back at any time."
    enable_pin= "Enable PIN"
    ...
    iris_desc = "Iris verification is a biometric technology based on your unique iris patterns, providing the highest level of security to ensure that only you can access your wallet."
    ...
    approve_confirm_desc = "After approval, you will allow this dApp to transfer your current token assets or execute transactions on your behalf."
