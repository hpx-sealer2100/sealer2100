...
from trezor import io, loop, ui, utils, log
import binascii
...
async def read_message(iface: Interface, buffer: utils.BufferType) -> Message:
...
async def write_message(iface: Interface, mtype: int, mdata: bytes) -> None:
