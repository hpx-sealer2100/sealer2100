...
from trezor.ui.layouts import confirm_verify_message
...
if TYPE_CHECKING:
    from trezor.messages import EthereumVerifyMessageHypermate as EthereumVerifyMessage
...
async def verify_message(ctx: Context, msg: EthereumVerifyMessage) -> Success:
    ...
    ctx.icon_path = get_icon(network.chain_id)
    await confirm_verify_message(
        ctx,
