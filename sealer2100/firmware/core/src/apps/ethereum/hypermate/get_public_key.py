...
from trezor.messages import EthereumPublicKeyHypermate as EthereumPublicKey, HDNodeType
...
if TYPE_CHECKING:
    from trezor.messages import EthereumGetPublicKeyHypermate as EthereumGetPublicKey
...
async def get_public_key(
    ...
    if msg.show_display:
        from ..helpers import get_icon, get_display_network_name
        ...
        ctx.primary_color, ctx.icon_path = get_icon(
