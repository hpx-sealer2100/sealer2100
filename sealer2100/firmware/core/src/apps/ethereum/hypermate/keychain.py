...
if TYPE_CHECKING:
    ...
    from trezor.messages import (
        EthereumGetAddressHypermate as EthereumGetAddress,
        EthereumGetPublicKeyHypermate as EthereumGetPublicKey,
        EthereumSignMessageHypermate as EthereumSignMessage,
        EthereumSignTxHypermate as EthereumSignTx,
        EthereumSignTxEIP1559Hypermate as EthereumSignTxEIP1559,
        EthereumSignTypedDataHypermate as EthereumSignTypedData,
        EthereumSignTypedHashHypermate as EthereumSignTypedHash,
    )
