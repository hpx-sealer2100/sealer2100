...
from trezor.messages import EthereumMessageSignatureHypermate as EthereumMessageSignature
...
if TYPE_CHECKING:
    from trezor.messages import EthereumSignMessageHypermate as EthereumSignMessage
...
async def sign_message(
    ...
    chain_id=None if network is not networks.UNKNOWN_NETWORK else msg.chain_id
