...
from trezor.messages import (
    ...
    EthereumTxAckHypermate as EthereumTxAck,
    EthereumTxRequestHypermate as EthereumTxRequest,
)
...
async def sign_tx(
    ...
    # have data, but not token and nft transfer
...
async def handle_erc20(
    ...
    if (
        ...
        == b"\xa9\x05\x9c\xbb\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" # transfer
    ):
